...
local function get_jdtls()
    vim.notify('Get JDTLS', 'info')
    local jdtls_path = vim.fn.exepath("jdtls")
    -- Obtain the path to the jar which runs the language server
    vim.notify('Getting LSP Launcher', 'info')
...
local function setup_jdtls()
    ...
    vim.notify('Project Root: ' .. root_dir, 'info')
    ...
    vim.notify('Getting CMP capailities', 'info')
    local lsp_capabilities = require('blink.cmp').get_lsp_capabilities()

    vim.notify('Mapping Capabilities', 'info')
    for k, v in pairs(lsp_capabilities) do
        capabilities[k] = v
    end

    vim.notify('Setup Capabilities', 'info')
    ...
    vim.notify('Setting Settings', 'info')
    ...
    vim.notify('Preparing Init Options', 'info')
    ...
    vim.notify('Preparing Config', 'info')
